<template>
  <footer class="flex flex-col w-full justify-between bg-dark2 text-white p-8 md:p-16 xl:p-24">
    <div class="w-full flex lg:flex-row flex-col justify-between mb-20 lg:mb-32">
      <div class="flex justify-between mb-12 flex-grow-40 lg:mb-0">
        <div class="w-full lg:leading-relaxed">
      ...
      <div class="flex flex-col justify-between lg:items-end flex-grow-60 text-white">
        ...
        <div class="flex links mb-4">
          <a href="mailto:info@sarasvati.co.id" class="focus:outline-none lg:p-3 lg:rounded-full p-1 mr-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="white"
              width="20"
        ...
        <div class="flex flex-row lg:mb-0 mb-3">
          <div class="w-full input-email">
            <input
              type="email"
              class="h-full w-full border-white focus:outline-none bg-transparent border-b lg:p-2 lg:w-64"
          ...
          <button
            class="button-anim-border focus:outline-none bg-transparent border-b border-white p-2 px-5 text-white uppercase tracking-widest"
          >
            <svg
              width="24"
              fill="white"
    ...
    <div class="flex flex-col justify-center items-center md:flex-row font-sans-alt text-sm">
      <p>&copy; 2019 &mdash; Roemah Seni Sarasvati</p>
      <p>
        <span class="hidden md:inline">.</span> All Rights Reserved
      </p>
    </div>
  </footer>
</template>
